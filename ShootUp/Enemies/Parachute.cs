...
public class Parachute : MonoBehaviour
{
    ...
    private Parachute_white targetParachute;
    ...
    void Start()
    {
        ...
        layerMask = LayerMask.GetMask("paratrooper_ally");
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                targetParachute = target.GetComponent<SoldierCollider>().parentObject.GetComponent<Parachute_white>();
            }

            if (this.animator.GetCurrentAnimatorStateInfo(0).IsName("Aiming") ||
                this.animator.GetCurrentAnimatorStateInfo(0).IsName("Aiming_red") ||
                this.animator.GetCurrentAnimatorStateInfo(0).IsName("Aiming_white"))
            {
                if (target != null)
                {
                    FireToSoldier();
    ...
    private void EnemyDetection()
    {
        ...
        {
            if (hitleft.transform.tag == "soldier_ally")
            {
        ...
        {
            if (hitright.transform.tag == "soldier_ally")
            {
